  ...
  <div>
    <el-container>
      <div style="margin-bottom: 10px">
        <el-input style="width: 300px" placeholder="请输入单位名称搜索" suffix-icon="el-icon-search" v-model="name"></el-input>
    ...
    <el-table :data="tableData" border stripe header-cell-class-name="headClass" @selection-change="handleSelectionChange" >
      ...
      <el-table-column prop="id" label="单位ID" width="90" align="center" >
      </el-table-column>
      <el-table-column prop="name" label="单位名称" align="center" >
      </el-table-column>
      <el-table-column prop="code" label="机构代码"  align="center" >
      </el-table-column>
      <el-table-column prop="actor" label="单位性质"  align="center" >
      </el-table-column>
      <el-table-column prop="address" label="地址" align="center"  >
      </el-table-column>
       <el-table-column prop="charger" label="单位负责人" align="center"  >
      </el-table-column>
      <el-table-column prop="telephone" label="单位电话" align="center"  >
      </el-table-column>
    ...
    <el-dialog title="单位信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form label-width="100px" size="small">
        ...
        <el-form-item label="单位性质">
          <el-select clearable v-model="form.actor" placeholder="请选择单位性质" style="width: 100%">
        ...
        <el-form-item label="负责人">
          <el-input v-model="form.charger" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods:{
    load() {
      ...
      this.request.get("/dept/actors").then(res => {
